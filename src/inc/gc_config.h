...
#define GC_THREAD_LOCAL_HEAP_SIZE                              (22768000)
#define GC_OLD_GENERATION_SEMISPACE_SIZE                       (22768000*2)

// Maximum sizes for when the heap does grow. Set to 0 to allow unlimited
// growth.
#define GC_THREAD_LOCAL_HEAP_MAX_SIZE_BEFORE_COLLECTION        (22768000)
#define GC_THREAD_LOCAL_HEAP_MAX_SIZE                          (22768000)
#define GC_OLD_GENERATION_SEMISPACE_MAX_SIZE_BEFORE_COLLECTION (22768000*2)
#define GC_OLD_GENERATION_SEMISPACE_MAX_SIZE                   (22768000*2)
