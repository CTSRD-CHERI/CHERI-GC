...
#define GC_OLD_GENERATION_SEMISPACE_SIZE                       65536
...
#define GC_OLD_GENERATION_SEMISPACE_MAX_SIZE_BEFORE_COLLECTION 65536
#define GC_OLD_GENERATION_SEMISPACE_MAX_SIZE                   65536
